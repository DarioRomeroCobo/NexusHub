...
const { mostrarRegistro, getUsuarios, registrarUsuario, cargarVideo, mostrarInicioSesion, mostrarSubirVideo, validarSesion, logout, mostrarVincularYoutube } = require('../controllers/usuarioController');
